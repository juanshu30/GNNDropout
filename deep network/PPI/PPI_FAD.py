...
class Net(torch.nn.Module):
    def __init__(self,num_layers,num_hidden,drop_rate):
        ...
        self.hidden_layers = nn.ModuleList([
            GCNConv(n_features if i==0 else num_hidden, num_hidden)
...
#np.savetxt("/home/shu30/Research_GraphDropout/AAAI/result/PPI_DropEdge_mean.txt",test_accs)
