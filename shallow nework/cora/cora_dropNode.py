...
class Net(torch.nn.Module):
    ...
    def forward(self,TRAIN,dr=None):
        ...
        if TRAIN == True:
            y = torch.bernoulli(torch.ones(data.num_nodes,1).to(device)*(1-self.droprate)).mul(y)
...
np.savetxt("/home/shu30/Research_GraphDropout/AAAI/result/GS_DropNode_mean.txt",accs_mean)
np.savetxt("/home/shu30/Research_GraphDropout/AAAI/result/GS_DropNode_var.txt",accs_var)