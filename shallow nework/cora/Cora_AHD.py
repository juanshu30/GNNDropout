...
#np.savetxt("/home/shu30/Research_GraphDropout/AAAI/result/cora_AHD.txt",accs_mean)
#np.savetxt("/home/shu30/Research_GraphDropout/AAAI/result/cora_AHD_var.txt",accs_var)